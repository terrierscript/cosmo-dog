...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../node_modules/stylis/stylis.js":[function(require,module,exports) {
var define;
/*
 *          __        ___
 *    _____/ /___  __/ (_)____
...
var generateTemplate = function generateTemplate(areaMap) {
    var colsMap = areaMap.areas.map(function (_a) {
        var area = _a.area,
            cols = _a.cols;
        var colsString = cols ? cols.join(" ") : "";
        var filled = area.map(function (item) {
            return !!item ? item : ".";
        });
        return "\"" + filled.join(" ") + "\" " + colsString;
    }).join("\n");
    var rowsString = areaMap.rows && areaMap.rows.length > 0 ? "/ " + areaMap.rows.join(" ") : "";
    var tmp = colsMap + rowsString;
    console.log(tmp);
    return tmp;
};
var gridTemplate = "\n  \"" + Area.header + " " + Area.header + " " + Area.header + "\" 60px\n               \". " + Area.body + " .\" 1fr\n  \"" + Area.footer + " " + Area.footer + " " + Area.footer + " \" 20px\n";
var Layout = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: grid;\n  grid-template: ", ";\n"], ["\n  display: grid;\n  grid-template: ", ";\n"])), generateTemplate(areaMap));
var LayoutArea = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  grid-area: ", "};\n"], ["\n  grid-area: ", "};\n"])), function (props) {
    return props.area;
});
var Foo = function Foo() {
    return React.createElement(Layout, null, React.createElement(LayoutArea, { area: Area.header }, "header"), React.createElement(LayoutArea, { area: Area.body }, "body"), React.createElement(LayoutArea, { area: Area.footer }, "footer"));
};
react_dom_1.default.render(React.createElement(Foo, null), document.getElementById("container"));
var templateObject_1, templateObject_2;
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","styled-components":"../node_modules/styled-components/dist/styled-components.browser.esm.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/src.24ad53cb.map